    ...
    <div className="flex flex-col w-full h-full items-center justify-center">
      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <div className="flex flex-col mt-4 w-11/12 text-center text-[#8696a0] text-base font-light">
          <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur debitis minus eligendi? .</h2>
          <h2>Perspiciatis quas placeat laborum maiores, asperiores, soluta saepe itaque earum, sed ducimus amet dolores error qui totam ipsum</h2>
        </div>
